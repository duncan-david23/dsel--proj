...
const Hero = () => {
  ...
  return (
    <section className="relative h-screen flex items-center justify-center overflow-hidden">
      ...
      <motion.div 
        className="absolute top-8 left-8 z-30 text-white"
      ...
      >
        <div className="flex items-center space-x-3">
          ...
          <div className="text-left">
            ...
            <motion.p 
              className="text-slate-300 text-sm font-light tracking-widest mt-1"
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
      ...
      <div className="relative z-10 text-center text-white px-4 w-full max-w-6xl">
        {/* Creative Brand Showcase - Above Main Content */}
        <motion.div
          className="mb-12"
        ...
        >
          <div className="inline-block bg-black/30 backdrop-blur-sm rounded-2xl px-8 py-4 border border-white/10">
            <motion.p 
              className="text-amber-400 text-lg font-light tracking-widest uppercase"
              initial={{ scale: 0.9 }}
              animate={{ scale: 1 }}
        ...
        <AnimatePresence mode="wait">
          ...
          >
            ...
            >
              ...
              <motion.span 
                className="block text-amber-400 mt-4 text-2xl md:text-3xl lg:text-4xl font-serif italic"
                initial={{ opacity: 0 }}
                animate={{ opacity: 1 }}
            ...
            <motion.p 
              className="text-xl md:text-2xl lg:text-3xl mb-8 max-w-3xl mx-auto font-light leading-relaxed text-slate-200"
            >
        ...
        >
          <motion.button 
            className="bg-amber-500 text-slate-900 px-10 py-5 rounded-full font-semibold text-lg hover:bg-amber-400 transition-all duration-300 shadow-2xl flex items-center space-x-3"
            whileHover={{ 
              scale: 1.05,
          ...
          <motion.button 
            className="border-2 border-white text-white px-8 py-5 rounded-full font-medium text-lg hover:bg-white hover:text-slate-900 transition-all duration-300 backdrop-blur-sm"
            whileHover={{ scale: 1.05 }}
            whileTap={{ scale: 0.95 }}
          >
            View Portfolio
        ...
        {/* Trust Indicators */}
        <motion.div 
          className="flex justify-center items-center space-x-8 mt-16 text-slate-300 text-sm"
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
